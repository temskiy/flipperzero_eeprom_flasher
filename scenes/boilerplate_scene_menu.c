...
void boilerplate_scene_menu_on_enter(void* context) {
    ...
    submenu_add_item(
        app->submenu, "Read", SubmenuIndexScene1, boilerplate_scene_menu_submenu_callback, app);
    submenu_add_item(
        app->submenu, "Write", SubmenuIndexScene2, boilerplate_scene_menu_submenu_callback, app);
    submenu_add_item(
        app->submenu,
        "Settings",
        SubmenuIndexSettings,
