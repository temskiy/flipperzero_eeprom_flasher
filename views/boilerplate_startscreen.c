...
void boilerplate_startscreen_draw(Canvas* canvas, BoilerplateStartscreenModel* model) {
    ...
    canvas_draw_str_aligned(canvas, 64, 10, AlignCenter, AlignTop, "EEPROM 24Cxxx flasher");
    canvas_set_font(canvas, FontSecondary);
    canvas_draw_str_aligned(canvas, 64, 22, AlignLeft, AlignTop, "SDA: Pin15");
    canvas_draw_str_aligned(canvas, 64, 32, AlignLeft, AlignTop, "SCL: Pin16");
