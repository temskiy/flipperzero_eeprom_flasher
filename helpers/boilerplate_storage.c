...
void boilerplate_save_settings(void* context) {
    ...
    flipper_format_write_uint32(fff_file, BOILERPLATE_SETTINGS_MEM_SIZE, &app->mem_size, 1);
...
void boilerplate_read_settings(void* context) {
    ...
    flipper_format_read_uint32(fff_file, BOILERPLATE_SETTINGS_MEM_SIZE, &app->mem_size, 1);
